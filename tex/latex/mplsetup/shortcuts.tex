...
\newcommand{\DRsl}{\ensuremath{\text{DR}_{\mathrm{sl}}}\xspace}
\newcommand{\DRbl}{\ensuremath{\text{DR}_{\mathrm{bl}}}\xspace}
\newcommand{\AR}{\ensuremath{\text{AR}}\xspace}
\newcommand{\SR}{\ensuremath{\text{SR}}\xspace}

\newcommand{\FFb}{\ensuremath{F_{\text{F},b}}\xspace}
\newcommand{\DRslb}{\ensuremath{\text{DR}_{\mathrm{sl}}^b}\xspace}
\newcommand{\DRblb}{\ensuremath{\text{DR}_{\mathrm{bl}}^b}\xspace}
\newcommand{\DRslcont}{\ensuremath{\text{DR}_{\mathrm{sl}}^{\text{cont}}}\xspace}
\newcommand{\DRblcont}{\ensuremath{\text{DR}_{\mathrm{bl}}^{\text{cont}}}\xspace}
...
xxh1:{$\xxH$ $≥2\,\text{Jet}$ $m_{jj}∊[350,700]$ $p_{T}^{H}<200$\xspace},
