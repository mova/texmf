...
% \newcommand{\tauhslash}{\ensuremath{{\hbox{\Pgth\kern-0.6em\lower-.05ex\hbox{/}\kern0.10em}}}}
%MET symbols
...
\newcommand{\mutau}{\ensuremath{\Pgm\Pgth}\xspace}
\newcommand{\etau}{\ensuremath{\Pe\Pgth}\xspace}
\newcommand{\tautau}{\ensuremath{\Pgth\Pgth}\xspace}
...
% \newcommand{\elltau}{\ensuremath{\ell\to\Pgth}}
% \newcommand{\jettau}{\ensuremath{\text{jet}\to\Pgth}}
...
% \newcommand{\jetfakes}{\ensuremath{\text{jet-to-}\Pgth}\xspace}
% \newcommand{\lfakes}{\ensuremath{\ell\text{-to-}\Pgt}\xspace}
\newcommand{\tt}{\ensuremath{\Pgt\Pgt}\xspace}
\newcommand{\lfakes}{\ensuremath{\ell\to\tauslash}}
\newcommand{\jetfakes}{\ensuremath{\text{jet}\to\tauslash}}
...
ggh3:{$\ggH$ $1\,\text{Jet}$ $p_{T}^{H}∊[120,200]$\xspace},
...
qqh4:{$\xxH$ $≥2\,\text{Jet}$ $m_{jj}∊[350,700]$ $p_{T}^{H}<200$\xspace},
xxh2:{$\xxH$ $≥2\,\text{Jet}$ $m_{jj}>700$ $p_{T}^{H}<200$\xspace}}
% 
\DefineDictionary{var}{%
pt_1:\ensuremath{p_{\mathrm{T},1}},%
pt_2:\ensuremath{p_{\mathrm{T},2}},%
eta:\ensuremath{η},%
eta_1:\ensuremath{η_1},%
m_vis:\ensuremath{m_{\mathrm{vis}}},%
ptvis:\ensuremath{p_{\mathrm{T},\mathrm{vis}}},%
m_sv_puppi:\ensuremath{m_{\mathrm{sv},\mathrm{puppi}}},%
m_sv:\ensuremath{m_{\mathrm{sv},\mathrm{puppi}}},%
bpt_1:\ensuremath{p_{\mathrm{T},\mathrm{b-jet},1}},%
jpt_1:\ensuremath{p_{\mathrm{T},\mathrm{jet},1}},%
jpt_2:\ensuremath{p_{\mathrm{T},\mathrm{jet},2}},%
jdeta:\ensuremath{δη_{jj}},%
mjj:\ensuremath{m_{jj}},%
dijetpt:\ensuremath{p_{\mathrm{T},jj}},%
mTdileptonMET_puppy:\ensuremath{m_{\mathrm{T},ll}^{\mathrm{MET}}},%
njets:\ensuremath{n_{\mathrm{jets}}},%
nbtag:\ensuremath{n_{\mathrm{b-tags}}},%
ME_q2v1:\ensuremath{\mathrm{ME}_{\mathrm{q2v1}}},%
ME_q2v2:\ensuremath{\mathrm{ME}_{\mathrm{q2v2}}}}